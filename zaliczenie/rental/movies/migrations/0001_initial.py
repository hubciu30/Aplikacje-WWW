    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.CharField(max_length=100, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Video',
            fields=[
                ...
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='videos', to='movies.client')),
            ],
        ),
    ]
